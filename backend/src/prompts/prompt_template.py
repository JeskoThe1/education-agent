...
education_analysis_prompt = PromptTemplate(
    template="""# Expert Analysis of Education Systems for Ukrainian Transformation
      ...
      It is crucial to include citations throughout your analysis. Use the following format:
      ...
      Include a citation immediately after each piece of information, statistic, or quote you use from the provided sources. It should be provided even if the source is not quoted word by word. For example:

      "The PISA results show that Country X's students scored an average of 520 in Mathematics, which is significantly above the OECD average of 489 [1, Page: 24]."

      "According to the Ministry of Education, 95% of graduates find employment within six months of graduation [2]."
      ...
      Remember: Every fact, figure, or direct quote must have a citation. This is crucial for maintaining the credibility and traceability of your analysis.
